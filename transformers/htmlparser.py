...
if 1 and __name__ == "__main__":
    ...
    test = "Luis Buñuel, <i>L’Âge d’Or</i> (“lodge dor”). For 10"
    test = 'power after overcoming Xiàng Yǔ’s</b> <span class="s2"><b>[shyong yoo’s]</b></span> <b>state of (*)</b> Chu.'
    tests = [
        "-1 0 1</i> 2</b>",
        "-1 0 1</b> 2",
        "-1 0</b> 1 2",
        "-1 0 <b>1 2",
        'ANSWER: <span class="s1"><b><i>Laocoön</i></b></span> <i>word',
        'ANSWER: <span class="s1"><b><i>Laocoön</i></b></span> <i>',
    ]
    for test in tests:
